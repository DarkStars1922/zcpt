...
- 人工审核（审核员/教师）：`/reviews/pending`、`/reviews/pending/category-summary`、`/reviews/pending/by-category`、`/reviews/{application_id}`、`/reviews/{application_id}/decision`、`/reviews/history`、`/reviews/pending-count`
